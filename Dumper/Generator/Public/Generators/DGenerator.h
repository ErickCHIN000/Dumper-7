...
public:
    ...
    static inline std::string MainFolderName = "DSDK";
...
private:
    ...
    static void GenerateSDKHeader(StreamType& SdkD);

    static void GenerateBasicFiles(StreamType& BasicD, StreamType& AssertionsFile);

    /*
    * Creates the UnrealContainers.d file (without allocation code) for the SDK. 
    ...
    */
    ...
    /*
    * Convert C++ types to D language equivalents
    */
    static std::string CppTypeToD(const std::string& CppType);
